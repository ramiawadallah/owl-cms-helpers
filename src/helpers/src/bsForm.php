...
class bsForm 
{
    ...
    {
        return view('Helper::bsForm.date',compact('name','value','attributes'))->render();
    }
    ...
    public static function translateuri($callback)
    {
        if (is_callable($callback)) 
        {
            return view('Helper::bsForm.translateuri',compact('callback'))->render();
        }
    }
